...
| ML benchmark metrics | Available | `outputs/final/`, with raw extracted evidence retained under `outputs/tables/step08_ml/extracted_tables/` |
...
| Model retraining entry point | Added | `src/step08_train_champion_v3.py --mode train` |
...
| Notebook output cells are not embedded | The final evidence was extracted into committed CSV/PNG outputs | Reviewer should audit `outputs/final/` and `docs/METRICS_SOURCE_OF_TRUTH.csv` instead of relying on notebook rendering |
